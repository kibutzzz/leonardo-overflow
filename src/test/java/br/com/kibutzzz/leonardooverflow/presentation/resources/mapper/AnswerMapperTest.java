...
class AnswerMapperTest {
  ...
  public void test_fromRequest_withValidRequest_shouldMapCorrectly() {
    ...
    final AnswerRequest validRequest = AnswerRequest.builder().description("DESCRIPTION").build();
  ...
  public void test_toResponse_withCompleteAnswer_shouldMapCorreclty() {
    ...
    final Answer answer = AnswerStubber.generateCompleteAnswer();
    final AnswerResponse expected = AnswerResponseStubber.generateCompleteResponse();
